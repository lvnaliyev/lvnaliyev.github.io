...
$(window).scroll(function () {
  ...
  timer = setTimeout(function () {
    ...
    if (resultcunt == "0") {
      ...
      subtextbox.innerHTML =
        "<div class='p20'><div class='p20p1'> <h1> My Certificates </h1> <div class='menu'><label for='menu_bar01'>Coding for Visual Learners - P5.js</label><input type='checkbox' id='menu_bar01' class='accordion' /><ul id='links01'><li><img src='/img/p5js'/></li></ul><label for='menu_bar02'>JavaScript Essential Training 2017</label><input type='checkbox' id='menu_bar02' class='accordion' /><ul id='links02'><li><img src='/img/JSessential2017'/></li></ul><label for='menu_bar03'>React - Creating and Hosting Full-Stack Site</label><input type='checkbox' id='menu_bar03' class='accordion'/><ul id='links03'><li><img src='/img/full-react'/></li></ul><label for='menu_bar04'>REACT: Building an Interface </label><input type='checkbox' id='menu_bar04' class='accordion' /><ul id='links04'><li><img src='/img/react_bi'/></li></ul><label for='menu_bar05'>Vue.js for Web Designers</label><input type='checkbox' id='menu_bar05' class='accordion' /><ul id='links05'><li><img src='/img/vue_web'/></li></ul><label for='menu_bar06'>Vue Essential Training</label><input type='checkbox' id='menu_bar06' class='accordion' /><ul id='links06'><li><img src='/img/vuesential'/></li></ul><label for='menu_bar07'>Building modern user interfaces with React</label><input type='checkbox' id='menu_bar07' class='accordion' /><ul id='links07'><li><img src=''/></li></ul></div>  </div>   <div class='scrolldown'></div><div class='dot'></div></div>";
