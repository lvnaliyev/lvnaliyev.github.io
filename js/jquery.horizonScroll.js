...
(function ($) {
  ...
  var scrollTo = function (index, speed) {
    ...
    $("html,body").animate(
      ...
      speed,
      "swing",
      $.fn.horizon.defaults.fnCallback(index)
    );
  ...
  var scrollLeft = function () {
    ...
    if (i2 < 0) {
      // If the previous index is negative, jump to the last section.
      scrollTo(
  ...
  var scrollRight = function () {
    ...
    if (i2 >= $.fn.horizon.defaults.limit) {
      // If the next index exceeds the limit, jump to the first section.
  ...
  var scrollAction = function (delta) {
    ...
    $.fn.horizon.defaults.scrollTimeout = setTimeout(
      scrollEndHandler,
      $.fn.horizon.defaults.scrollEndDelay
    );
  };
